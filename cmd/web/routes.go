...
func routes(app *Application) http.Handler {
	...
	mux.Get("/guest", dynamicMiddleware.ThenFunc(app.GuestHome))
	...
	// // Celebrants Routes
	// mux.Get("/celebrants", dynamicMiddleware.ThenFunc(app.GetAllEvents))                                           // Get all celebrants
